...
export const PAYMENT_URI_CASES: PaymentUriCase[] = [
  ...
  },
  {
    ...
    input: { destination: VALID_DESTINATION, amount: '25.0000000', memo: MEMO_32_BYTES },
    expected: {
      kind: 'uri',
      uri: `web+stellar:pay?destination=${VALID_DESTINATION}&amount=25.0000000&memo=${MEMO_32_BYTES}&memo_type=MEMO_TEXT`,
      params: {
        destination: VALID_DESTINATION,
        amount: '25.0000000',
        memo: MEMO_32_BYTES,
  ...
  },
  {
    ...
    input: { destination: VALID_DESTINATION, amount: '25.0000000', memo: MEMO_30_BYTES_NON_ASCII },
    expected: {
      kind: 'uri',
      uri: `web+stellar:pay?destination=${VALID_DESTINATION}&amount=25.0000000&memo=${encodeURIComponent(MEMO_30_BYTES_NON_ASCII)}&memo_type=MEMO_TEXT`,
      params: {
        destination: VALID_DESTINATION,
        amount: '25.0000000',
