...
export interface MobileFallbackCopy {
  badge: string;
  headline: string;
  description: string;
  noAuthNote: string;
  options: {
    mobileWallet: FallbackOption;
    manualTransfer: FallbackOption;
    desktopHandoff: FallbackOption;
  };
  unsupportedNotice: string;
}

export const MOBILE_FALLBACK_COPY: MobileFallbackCopy = Object.freeze({
