...
test('parseStroops accepts the issue #520 fixtures', () => {
  assert.equal(parseStroops('0.0000001'), 1n);
  assert.equal(parseStroops(0.0000001), 1n); // number arrives as 1e-7
...
test('amountsEqual is stroop-exact', () => {
  ...
  assert.equal(amountsEqual('10.0000000', '9.9999999'), false); // one stroop short
